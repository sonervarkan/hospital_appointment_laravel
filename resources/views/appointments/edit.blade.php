...
<body>
    ...
    <form action="{{ route('appointments.update', $appointment->id) }}" method="POST">
        ...
        <input type="text" name="patient_name" id="patient_name" value="{{ $appointment->patient->patient_name }}" required>

        <label for="patient_surname">Patient Surname:</label>
        <input type="text" name="patient_surname" id="patient_surname" value="{{ $appointment->patient->patient_surname }}" required>

        <label for="patient_tc_no">Patient Tc No:</label>
        <input type="text" name="patient_tc_no" id="patient_tc_no" value="{{ $appointment->patient->patient_tc_no }}" required>
        ...
        <select name="time_id" id="time_id">
            @foreach ($times as $time)
                <option value="{{ $time->id }}" {{ $appointment->time_id == $time->id ? 'selected' : '' }}>
                    {{ $time->appointment_hour }}
                </option>
            @endforeach
        </select>
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    // Department seçilince doktorları getir
    ...
    // Doctor veya date değişince available saatleri getir
